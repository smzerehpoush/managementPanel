...
import com.nrdc.adminPanel.impl.AP.ResetPasswordAPToDefaultImpl;
...
@Path("/resetPasswordAPToDefault")
public class ResetPasswordAPToDefaultService extends SimpleService {
    private static Logger logger = Logger.getLogger(ResetPasswordAPToDefaultService.class.getName());
    ...
    public Response addUser(RequestResetPasswordDefault requestResetPasswordDefault) {
        ...
        try {
            ...
            VTResponse<ResponseResetPasswordDefault> response = new ResetPasswordAPToDefaultImpl().resetPassword(requestResetPasswordDefault);
